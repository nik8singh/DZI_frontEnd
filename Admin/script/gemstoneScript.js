...
$('#gemList').on('click', ".addNewGem", function () {
    ...
    myObject.gemstoneName = name;
    myObject.gemstoneDescription = desc;

    let myValues = JSON.stringify(myObject);
    let self = this;
    $.ajax({
        url: url + "add",
        type: 'POST',
        ...
        success: function (result, status) {
            ...
            let r = "<tr class=\"tbl-item\"><td class=\"img\"><img src=" + image + " alt=\"\" title=\"\"/></td><td class=\"td-block\"><p class=\"date\">" + currentDate + "</p><textarea  class=\"title gemEditableFields gemTitle \"  disabled>" + name + "</textarea><textarea class=\"desc gemDesc gemEditableFields\"  rows=\"10\" cols=\"80\" disabled>" + desc + "</textarea><p class=\"like\" style=\"float: left\">Last updated: " + currentDate + "</p><a href=\"#\" class=\"gemButtons editGem\" >Edit</a><a class=\"updateGem gemButtons\" href=\"#\" hidden>Update</a><a class=\"cancelUpdateGem gemButtons\" href=\"#\" hidden>Cancel</a><a class=\"deleteGem gemButtons\" href=\"#\" hidden>Delete Gemstone</a></td></tr>";
            $(".demo-tbl").prepend(r);
